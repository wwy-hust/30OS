 ...
 *  
 *  @param esp value of keyboard operation.
 *  @return NULL
 */
...
/** @brief interrupt routine of mouse.
 *  
 *  @param esp value of mouse operation.
 *  @return NULL
 */
...
/** @brief wait for keyboard to be ready for next operation.
 *  
 *  @param NULL
 *  @return NULL
 */
...
/** @brief init buffer for mouse and keyboard.
 *  
 *  @param NULL
 *  @return NULL
 */
 ...
 *  @param NULL
 *  @return whether the init is successful. if yes, return TRUE els FALSE;
 */
boolean InitMouse()
{
	boolean re;
...
/** @brief capture mouse and keyboard interruption, save them for future use.
 *  Tackle the interruption of mouse and keyboard. move the mouse directly, save the keyboard state into keyboardCtl.
 *  program should get the pressed key from keyboardCtl through KeyboardGetChar().
 *  @param NULL
 *  @return NULL
 */
...
/** @brief get pos of mouse
 *  
 *  @param pos return the pos of current mouse.
 *  @return NULL.
 */
...
/** @brief get keyvalue of mouse
 *  
 *  @param keydown get the keyvalue of mouse
 *  @return NULL.
 */
...
/** @brief get key pressed value from keyboardCtl
 *  
 *  @param buffer the buffer to contain these buffer.
 *  @param cnt the length of buffer.
 *  @return the cnt key value in the buffer. would be less than var cnt.
 */
